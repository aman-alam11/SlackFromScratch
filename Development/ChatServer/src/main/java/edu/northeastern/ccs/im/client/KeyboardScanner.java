...
/**
 * This class is similar to the java.util.Scanner class, but is tuned to read Strings from the
 * keyboard. This class's methods will return immediately and, if there is no input available, will
 * not hang until the user types something in (it is &quot;non-blocking&quot; in technical
 * parlance).
 *
...
public final class KeyboardScanner {
  /**
   * To make this class "non-blocking", we open the scanner instance in another thread. As a result,
   * any blocking will occur in the other class.
   */
  ...
  /**
   * Creates a new instance of this class. Since, by definition, this class takes in input from the
   * keyboard we do not need any parameters for this constructor.
   */
  ...
  /**
   * Returns the singleton instance of this class. If the singleton instance does not yet exist,
   * this method will instantiate it.
   *
   * @return Singleton instance that can be used to read keyboard input in a non-blocking manner.
   */
    ...
    if (singleton == null) {
      synchronized (KeyboardScanner.class) {
        if (singleton == null) {
          ...
          // class will examine.
          addKeyboardInputAsMessageHelper();
  ...
  /**
   * Restart scanning for keyboard input after we have closed some keyboard scanner.
   */
  ...
  private static void addKeyboardInputAsMessageHelper() {
    producer = new Thread(() -> {
  ...
  /**
   * Returns true if there is another line of keyboard input. This method will NOT block while
   * waiting for input. This class does not advance past any input.
   *
   * @return True if and only if this instance of the class has another line of input from the
   * keyboard available.
